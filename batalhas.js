const batalhas = [
  ...
  },
  {
    ...
    cidade: "Araraquara - SP",
    dia: "Segunda-feira",
    coords: [-21.789150, -48.176050], // Ajustado Jitter
  ...
  },
  {
    ...
    cidade: "Araraquara - SP",
    dia: "Terça-feira",
    coords: [-21.789380, -48.176280], // Ajustado Jitter
  ...
  },
  {
    ...
    cidade: "Araraquara - SP",
    dia: "Sábado",
    coords: [-21.788950, -48.175850], // Ajustado Jitter
  ...
  },
  {
    ...
    cidade: "Araraquara - SP",
    dia: "Sábado",
    coords: [-21.789250, -48.175950], // Ajustado Jitter
  ...
  },
  {
    ...
    cidade: "São Carlos - SP",
    dia: "Sexta-feira",
    coords: [-22.017750, -47.891150], // Ajustado Jitter
  ...
  },
  {
    ...
    coords: [-20.8066, -49.3725], // Coordenada específica da Represa
  ...
  },
  {
    ...
    cidade: "Araraquara - SP",
    dia: "Quarta-feira",
    coords: [-21.789120, -48.176020], // Ajustado Jitter
  ...
  },
  {
    ...
    cidade: "Araraquara - SP",
    dia: "Domingo",
    coords: [-21.789180, -48.176080], // Ajustado Jitter
  ...
  {
    codigo: "BAT057",
    nome: "Batalha do Braile",
    cidade: "São José do Rio Preto - SP",
    dia: "Domingo",
    coords: [-20.8258, -49.3812], // Coordenada específica da Praça do Braile
    rede: "",
    descricao: "Local: Praça do Braile.",
    campeoes_historicos: [],
    redes_sociais_links: []
  },
  {
    ...
    cidade: "Ribeirão Preto - SP",
    dia: "Sexta-feira",
    coords: [-21.1775, -47.8103], // Próximo ao Coreto da Catedral
    rede: "",
    descricao: "Local: Coreto da Catedral.",
    campeoes_historicos: [],
    redes_sociais_links: []
  }
];